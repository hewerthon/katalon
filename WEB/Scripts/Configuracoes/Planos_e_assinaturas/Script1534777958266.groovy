...
WebUI.click(findTestObject('Object Repository/Configuracao/Page_Meu Patrocnio/a_Planos e assinaturas'))

WebUI.click(findTestObject('Object Repository/Configuracao/Page_Meu Patrocnio/h4_Planos e assinaturas'))
