...
WebUI.click(findTestObject('Object Repository/Configuracao/Page_Meu Patrocnio/li_Usurios bloqueados'))
...
WebUI.verifyElementText(findTestObject('Page_Meu Patrocnio/p_Voc no bloqueou ningum at o '), 'Você não bloqueou ninguém até o momento')
